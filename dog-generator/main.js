...
fetch(BREEDS_URL)
   ...
   const doggoInfo = {
      ...
      assignMF() {
         ...
         document.getElementById('mf').innerHTML= `<b>Sex:</b> ${this.MF}`
      },

      assignName(array) {
         this.rname = array[Math.floor(Math.random()*array.length)]
         document.getElementById('idDogName').innerHTML = `${this.rname}`
      },
      ...
      assignFunFact() {
         ...
         document.getElementById('funFact').innerHTML = `<b>Additional Info:</b> ${this.fact}`
      }
  }
